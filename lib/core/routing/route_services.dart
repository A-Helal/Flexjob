...
class CustomMainRouter {
  ...
  static void navigate(PageRouteInfo route, {FutureOr<dynamic> Function(Object?)? then}) {
  ...
  static void push(PageRouteInfo route, {FutureOr<dynamic> Function(Object?)? then}) {
    appRouter.push(route).then(then ?? (Object? value) {});
  }

  static void pushAndPopUntil(PageRouteInfo route) {
    appRouter.pushAndPopUntil(route, predicate: (Route<dynamic> route) => false);
  }
}
