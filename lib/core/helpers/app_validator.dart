...
class NoPasteInputFormatter extends TextInputFormatter {
  ...
  String? validateInstPay(BuildContext context, String email) {
    final RegExp regex = RegExp(r"^[a-zA-Z0-9._%+-]+@instapay\.com$");

    if (email.isNotEmpty && !regex.hasMatch(email)) {
      return context.tr(AppLocalizationKeys.instaPayError);
    }
    return null;
  }
}
