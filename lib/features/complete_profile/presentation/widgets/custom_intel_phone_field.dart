...
import 'package:flutter/cupertino.dart' show Decoration;
import 'package:flutter/foundation.dart' show kIsWeb;
import 'package:flutter/material.dart';
import 'package:flutter/painting.dart' show Decoration;
import 'package:flutter/rendering.dart' show Decoration;
import 'package:flutter/services.dart';
import 'package:flutter/widgets.dart' show Decoration;
...
class CustomIntlPhoneField extends StatefulWidget {
  ...
  final VoidCallback? onTapToChanegCountry;
...
class _CustomIntlPhoneFieldState extends State<CustomIntlPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      // parse initial value
      _selectedCountry = countries.firstWhere((Country country) => number.startsWith(country.fullCountryCode),
      ...
      _selectedCountry = _countryList.firstWhere(
          (Country item) =>
              item.dialCode == (widget.initialCountryCode!.replaceAll("+", "")) ||
    ...
    if (widget.autovalidateMode == AutovalidateMode.always) {
      ...
      final FutureOr<String?>? value = widget.validator?.call(initialPhoneNumber);
  ...
  Future<void> _changeCountry() async {
    widget.onTapToChanegCountry?.call();
    filteredCountries = _countryList;
    await showDialog(
      context: context,
      useRootNavigator: false,
      builder: (BuildContext context) => StatefulBuilder(
        builder: (BuildContext ctx, setState) => CountryPickerDialog(
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      key: ValueKey('${_selectedCountry.code}_${number}'),
      initialValue: number,
      autofillHints: widget.disableAutoFillHints ? null : <String>[AutofillHints.telephoneNumberNational],
      readOnly: widget.readOnly,
      obscureText: widget.obscureText,
      textAlign: LanguageHelper.isAr(context) ? TextAlign.right : TextAlign.left,
